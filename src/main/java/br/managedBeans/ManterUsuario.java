	...
	public String adicionarUsuario() {
		...
		if(!getUsuarioAdd().getSenha().equals(getUsuarioAdd().getConfirmacaoSenha())){
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_ERROR, "A senha não é igual à confirmação de senha!", ""));
		...
		if(userDB != null){
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_ERROR, "Já existe um registro com esse login ou e-mail!", ""));
			return "addUsuario.xhtml";
		}else{
			...
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_INFO, "Usuário registrado com sucesso!", ""));
			setUsuarioAdd(null);
		}
